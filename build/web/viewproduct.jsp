        ...
        <td><form name="form1" method="post" action="">
          <p><%
              ...
              try
              {
                  ...
                  try
                  {
                      String q="select * from addproduct where subcatid=?";
                     ...
                     if(answer.next())
                     {
                          ...
                          do
                          {
                              ...
                              out.print("<td><a href='moredetails.jsp?id="+answer.getString("productid")+"'>"
                                      + "<img src='userimages/"+answer.getString("image")+"' width='250px'"
